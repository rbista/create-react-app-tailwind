  ...
  return (
    <div className="bg-gray-900 p-6 h-screen grid grid-cols-5">
      <div className="sm:col-span-2 md:col-span-1 bg-gray-800 p-6 rounded-lg">
        ...
        <input type="range" min="10" max="180" step="10" value={gameDuration} onChange={handleDurationChange} />
        ...
        <div className="flex items-center w-full mb-12">
          ...
          <label className="flex items-left cursor-pointer">
            ...
            <div className="relative">
              <input type="checkbox" id="toggleB" className="sr-only" onChange={handleFontCapChange} disabled />
      ...
      <button className="p-4 bg-green-600 rounded-lg font-bold text-white mt-5 hover:bg-gray-600">
        ...
        {gameStatus && (<button className="p-4 w-full bg-red-600 rounded-lg font-bold text-white mt-5 hover:bg-gray-600" onClick={()=>setGameStatus(false)}>
          Stop Game
        </button>)}
