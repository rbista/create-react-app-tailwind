    ...
    <div className="bg-gray-900 min-h-screen grid sm:grid-cols-5 p-3">
      ...
      <div className="col-span-full md:col-span-1 rounded-lg min-h-full">
        <div className="bg-gray-700 p-3 rounded-lg w-full grid sm:grid-cols-3">
          <button className="col-span-1 p-4 bg-purple-600 rounded-lg font-bold text-white mb-4 hover:bg-purple-700 flex justify-center items-center" onClick={() => setDisplayContent(ACTIONLIST)}>
            Actions
          </button>
