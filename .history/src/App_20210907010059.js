...
const App = (props) => {
  ...
  // const setFontSize=()=
  return (
    <div className="bg-gray-900 min-h-screen grid grid-cols-none sm:grid-cols-5 p-3 gap-4">

      <div className="col-auto md:col-span-1 rounded-lg sm:min-h-full">
      ...
      {displayContent === ACTIONLIST &&
        (<div className="col-span-1 sm:col-span-3 md:col-span-4 text-white p-6">
