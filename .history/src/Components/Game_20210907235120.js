...
const Game = (props) => {
  ...
  const { gameDuration, alphaRules, timerSpeed, fontSize, fontCapital,setFontCapital, gameStatus, setGameStatus, defaultData } = props;
  ...
  return (
    <div className=" flex flex-col flex-wrap justify-center content-center h-full">
      {!showTimer && !showContent && (
        <Settings defaultData={defaultData} fontCapital={fontCapital} setFontCapital={setFontCapital} gameStatus={gameStatus} setNoOfChars={setNoOfChars} />
      )}
      {showContent && (
