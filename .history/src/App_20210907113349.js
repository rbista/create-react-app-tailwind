...
const App = (props) => {
  ...
  // const setFontSize=()=
  return (
    <div className="bg-gray-900 sm:min-h-screen p-3 grid auto-rows-min sm:grid-cols-2 md:grid-cols-5 grid-rows-2 sm:grid-rows-1  gap-2">

      <div className="sm:col-span-1 row-span-1 rounded-lg">
      ...
      <div className="sm:col-span-4 row-span-1">
