  ...
  return (
    <div className="bg-gray-900 p-6 h-screen grid grid-cols-5">
      <div className="sm:col-span-2 md:col-span-1 bg-gray-800 p-6 rounded-lg">
        ...
        <button className="bg-purple-600 w-full rounded-lg font-bold text-white mt-5 hover:bg-purple-700 flex justify-center items-center" onClick={() => setDisplayContent(ACTIONLIST)}>
          Actions
        </button>
        <button className="w-full bg-purple-600 rounded-lg font-bold text-white mt-5 hover:bg-purple-700" onClick={() => setDisplayContent(RULES)}>
          Rules
        </button>
        <button className="w-full bg-green-400 rounded-lg font-bold text-white mt-5 hover:bg-green-700" onClick={() => setDisplayContent(START)}>
            Game
          </button>
