...
const App = (props) => {
  ...
  return (
    ...
    <div className="grid sm:grid-cols-5">
      <div className="sm:col-span-1 md:col-span-2 bg-gray-800 text-white text-center">
A
      </div>
      <div className="sm:col-span-4 md:col-span-3 bg-blue-300 text-white text-center">
B
console.assert(v
<br/>
v
