        ...
        <dialog open={modalStatus} className="rounded-lg bg-white rounded shadow-lg w-10/12 md:w-1/2 p-0">
          ...
          <div class="p-3">
            <label class="block">
              ...
              <input class="block w-full appearance-none placeholder-gray-500 border border-gray-400 rounded-md py-3 px-4 my-1 text-gray-700 leading-5 focus:outline-none focus:ring-2 focus:ring-blue-200" placeholder="Action Name" required />
            </label>
            <label class="block">
              <span class="text-gray-700">Action Letter</span>
              <input class="block w-full appearance-none placeholder-gray-500 border border-gray-400 rounded-md py-3 px-4 my-1 text-gray-700 leading-5 focus:outline-none focus:ring-2 focus:ring-blue-200" placeholder="Action Letter" required/>
            </label>
          </div>
