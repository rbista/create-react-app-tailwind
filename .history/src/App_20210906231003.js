  ...
  return (
    <div className="bg-gray-900 p-6 h-screen grid grid-cols-5">
      ...
      <button className="p-4 bg-green-600 rounded-lg font-bold text-white mt-5 hover:bg-gray-600">
        ...
        <button className="p-4 bg-purple-600 w-full rounded-lg font-bold text-white mt-5 hover:bg-purple-700 flex items-center" onClick={() => setShowActions(!showActions)}>
