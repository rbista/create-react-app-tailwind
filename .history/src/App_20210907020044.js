...
const App = (props) => {
  ...
  // const setFontSize=()=
  return (
    <div className="bg-gray-900 min-h-screen p-3 grid grid-rows-7 sm:grid-cols-2 md:grid-cols-5 gap-2">

      <div className="row-span-1 row-start-5 sm:col-span-1 rounded-lg">
      ...
      {displayContent === START && (<div className="row-start-1 row-end-6 sm:col-span-4  flex flex-col flex-wrap justify-center content-center">
