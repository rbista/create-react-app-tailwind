...
const App = (props) => {
  const FONTSIZEARRAY = ['2xl', '3xl', '4xl', '5xl', '6xl', '7xl', '8xl', '9xl'];
  ...
  // const setFontSize=()=
  return (
    <div className="bg-gray-900 min-h-screen grid grid-cols-5">

      <div className="sm:col-span-2 md:col-span-1 p-3 my-3 rounded-lg min-h-full">
        ...
        {/* {displayContent === START && (<div className="bg-gray-700 p-3 my-3 rounded-lg w-full">
      ...
      {displayContent === START && (<div className="sm:col-span-3 md:col-span-4 flex flex-col flex-wrap justify-center content-center">
        {!showTimer && !showContent && (<div className="col-spans-2 bg-gray-700 p-3 my-3 rounded-lg ">
          <h1 className={`text-xl text-white`}>Game Settings</h1>
          <p className={'text-gray-400 mt-5 text-lg'}>
            Font Size:
          </p>
          <h1 className={`text-${fontSize} text-white ${fontCapital ? 'uppercase' : 'lowercase'}`}>A</h1>
          <input type="range" min="0" max={fontSizeLength-1} value={sliderValue} onChange={handleFontChange} disabled={gameStatus} />
          <p className={'text-gray-400 mt-5 text-lg'}>
            Game Speed: <span className="test-gray-500">{timerSpeed} sec</span>
          </p>
          <input type="range" min="1" max="10" value={timerSpeed} onChange={handleTimerSpeedChange} disabled={gameStatus} />
