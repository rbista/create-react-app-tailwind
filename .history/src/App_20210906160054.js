...
const App = (props) => {
  ...
  return (
    <div className="bg-gray-900 p-20 h-screen flex justify-center items-start flex-col">
      ...
      <input class="block appearance-none placeholder-green-500 border border-emerald-400 rounded-md w-full py-3 px-4 text-green-700 leading-5 focus:outline-none focus:ring-2 focus:ring-emerald-200" placeholder="jane@example.com"/>
      <input class="placeholder-gray-500 ..." placeholder=""/>
