...
const App = (props) => {
  ...
  return (
    <div className="bg-gray-900 p-20 h-screen flex justify-center items-start flex-col">
      ...
      <input class="block appearance-none placeholder-green-500 border border-green-400 rounded-md w-full py-3 px-4 m-1 text-green-700 leading-5 focus:outline-none focus:ring-2 focus:ring-green-200" placeholder="jane@example.com"/>
