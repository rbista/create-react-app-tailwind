...
const App = (props) => {
  ...
  return (
    <div className="bg-gray-900 min-h-screen p-3 grid sm:grid-cols-5 gap-2">
      ...
      <div className="sm:col-span-1 md:col-span-2 rounded-lg">
      ...
      {displayContent === START && (<div className="sm:col-span-4  md:col-span-3 flex flex-col flex-wrap justify-center content-center">
      ...
      {displayContent === RULES && (<div className="sm:col-span-4 md:col-span-3 text-center">
