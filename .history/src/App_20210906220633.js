        ...
        <dialog open={modalStatus} className="rounded-lg bg-white rounded shadow-lg w-10/12 md:w-1/2 p-0">
          ...
          <div class="p-3">
            <label class="block">
              ...
              <input class="block w-full appearance-none placeholder-green-500 border border-green-400 rounded-md py-3 px-4 my-1 text-green-700 leading-5 focus:outline-none focus:ring-2 focus:ring-green-200" placeholder="Action Name" required />
            </label>
            <label class="block">
              <span class="text-gray-700">Action Letter</span>
              <input class="block w-full appearance-none placeholder-green-500 border border-green-400 rounded-md py-3 px-4 my-1 text-green-700 leading-5 focus:outline-none focus:ring-2 focus:ring-green-200" placeholder="Action Letter" required/>
            </label>
          </div>
          <div class="flex justify-end items-center w-100 border-t p-3">
            <button class="bg-white hover:bg-gray-300 px-3 py-1 rounded mr-1 close-modal">Cancel</button>
            <button class="bg-blue-600 hover:bg-blue-700 px-3 py-1 rounded text-white" type="submit">Save</button>
            {/* </div> */}
            {/* </div> */}
