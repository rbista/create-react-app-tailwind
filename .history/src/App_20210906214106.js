    ...
    <div className="bg-gray-900 p-6 h-screen grid grid-cols-5">
      ...
      {showActions &&
        ( <div className="sm:col-span-3 md:col-span-4 text-white p-6">
            ...
            <div className="m-3">
              <button className="p-2 bg-blue-600 rounded-lg font-bold text-white mt-5 hover:bg-blue-700 flex items-center" onClick={handleModalChange}>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 fill-current text-white-600 pr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
                </svg>  Add Action
              </button>
            </div>
            <dialog open={modalStatus}>This is an open dialog window</dialog>
          </div>)}
    </div>
