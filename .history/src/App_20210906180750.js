...
const App = (props) => {
  ...
  // const setFontSize=()=
  return (
    <div className="bg-gray-900 p-20 h-auto grid grid-cols-5">
      <div className="col-span-1">
      <h1 className={`text-xl text-white-900 `}>Game Settings</h1>
      ...
      <div className="col-span-4 flex flex-wrap justify-center content-center">
