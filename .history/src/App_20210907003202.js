...
const App = (props) => {
  ...
  // const setFontSize=()=
  return (
    <div className="bg-gray-900 min-h-screen grid md:grid-cols-5 p-3">
      ...
      {displayContent === START && (<div className="sm:col-span-full  md:col-span-5 flex flex-col flex-wrap justify-center content-center">
        {!showTimer && !showContent && (<div className="sm:w-full md:w-2/4 bg-gray-700 p-3 my-3 rounded-lg">
