...
const App = (props) => {
  ...
  const genCharAction=()=>{
    ALPHABET.map(alpha=>{
      console.log("ALPSHA RULES: alphaRules ", alphaRules);

      const tempRules= [...alphaRules,{name:alpha, value: ACTIONS[randomAction()].value}];
       console.log("ALPSHA RULES: ", tempRules);
  ...
  return (
    <div className="bg-gray-900 p-6 h-screen grid grid-cols-5">
      ...
      {!showRules &&(<div className="sm:col-span-3 md:col-span-4 flex flex-wrap justify-center content-center">
      ...
      {showRules && (<div className="grid grid-cols-7 sm:col-span-3 md:col-span-4 text-center">
        {alphaRules.map((alpha)=>(<div className="col-span-1 bg-gray-600 m-2 flex flex-wrap justify-center content-center rounded-lg" key={randomChar()}>
