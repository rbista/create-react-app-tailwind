...
const App = (props) => {
  ...
  // const setFontSize=()=
  return (
    <div className="bg-gray-900 min-h-screen grid grid-cols-5 p-3">

      <div className="sm:col-span-2 md:col-span-1 p-3 rounded-lg min-h-full">
      ...
      {displayContent === START && (<div className="sm:col-span-3 md:col-span-4 flex flex-col flex-wrap justify-center content-center">
        ...
        {gameStatus && (<button className="p-4  bg-red-600 rounded-lg font-bold text-white mt-5 hover:bg-red-700" onClick={handleStopGame}>
            Stop Game
          </button>)}
      </div>)}
