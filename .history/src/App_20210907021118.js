...
const App = (props) => {
  ...
  // const setFontSize=()=
  return (
    <div className="bg-gray-900 min-h-screen p-3 grid grid-rows-6 sm:grid-cols-2 md:grid-cols-5 gap-2">
      ...
      {displayContent === START && (<div className="row-span-4 sm:col-span-4  flex flex-col flex-wrap justify-center content-center">
