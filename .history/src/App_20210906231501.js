    ...
    <div className="bg-gray-900 p-6 h-screen grid grid-cols-5">
      <div className="sm:col-span-2 md:col-span-1 bg-gray-800 p-6 rounded-lg">
        ...
        <div className="flex items-center w-full mb-12">
         ...
         <button className="p-4 bg-purple-600 w-full rounded-lg font-bold text-white mt-5 hover:bg-purple-700 flex justify-center items-center" onClick={() => setShowActions(!showActions)}>
          Actions
        </button>
        ...
        <button className="p-4 w-full bg-purple-600 rounded-lg font-bold text-white mt-5 hover:bg-purple-700" onClick={() => setShowRules(!showRules)}>
          Rules
        </button>
