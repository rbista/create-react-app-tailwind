  ...
  return (
    <div className="bg-gray-900 p-6 h-screen grid grid-cols-5">
      ...
      <div className={`h-screen w-full fixed left-0 top-0 flex justify-center items-center bg-opacity-90 bg-gray-900 ${modalStatus ? 'block' : 'hidden'}`}>
        ...
        <label class="block">
                <span class="text-gray-700">Full name</span>
                <input class="block w-full appearance-none placeholder-green-500 border border-green-400 rounded-md py-3 px-4 m-1 text-green-700 leading-5 focus:outline-none focus:ring-2 focus:ring-green-200" placeholder="Action Letter"/>
                <input type="text" class="mt-1 block w-full rounded-md bg-gray-100 border-transparent focus:border-gray-500 focus:bg-white focus:ring-0" placeholder=""/>
              </label> 
               </div>
