...
const App = (props) => {
  ...
  return (
    <div className="bg-gray-900 min-h-screen grid sm:grid-cols-5 p-3">
      ...
      <div className="col-span-full md:col-span-1 rounded-lg min-h-full">
        <div className="bg-gray-700 p-3 rounded-lg w-full grid grid-cols-3">
          <div className="col-span-1 mr-2 sm:col-span-full sm:m-0">
          <button className=" p-4 w-full bg-purple-600 rounded-lg font-bold text-white mb-4 hover:bg-purple-700 flex justify-center items-center" onClick={() => setDisplayContent(ACTIONLIST)}>
            Actions
          </button>
          </div>
          <div className="col-span-1 mr-2 sm:col-span-full sm:m-0">
          ...
          <div className="col-span-1 sm:col-span-full sm:m-0">
          ...
          <div className="col-span-3 sm:col-span-full sm:m-0">
