...
const App = (props) => {
  ...
  return (
    <div className="bg-gray-900 p-6 h-screen grid grid-cols-5">
      ...
      {showRules && (<div className="grid grid-cols-7 sm:col-span-3 md:col-span-4 justify-center content-center text-center">
        {ALPHABET.map((alpha)=>(<div className="col-span-1">
