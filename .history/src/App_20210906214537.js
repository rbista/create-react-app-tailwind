    ...
    <div className="bg-gray-900 p-6 h-screen grid grid-cols-5">
      ...
      {showActions &&
        ( <div className="sm:col-span-3 md:col-span-4 text-white p-6">
            ...
            <dialog open={modalStatus} className="rounded-lg"><div class="border-b px-4 py-2 flex justify-between items-center rounded-lg">
        <h3 class="font-semibold text-lg">Modal Title</h3>
        <button class="text-black close-modal"><svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
