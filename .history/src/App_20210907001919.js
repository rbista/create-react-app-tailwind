...
const App = (props) => {
  ...
  return (
    <div className="bg-gray-900 min-h-screen grid grid-cols-5 p-3">
      ...
      {displayContent === START && (<div className="sm:col-span-3 sm:max-w-full md:max-w-2xl md:col-span-4 flex flex-col flex-wrap justify-center content-center">
        {!showTimer && !showContent && (<div className="sm:w-full md:min-w-min bg-gray-700 p-3 my-3 rounded-lg">
