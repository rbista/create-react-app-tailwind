...
const App = (props) => {
  ...
  // const setFontSize=()=
  return (
    <div className="bg-gray-900 min-h-screen p-3 grid sm:grid-cols-5 gap-4">

      <div className="sm:col-span-1 rounded-lg">
        <div className="bg-gray-700 p-3 rounded-lg w-full grid grid-cols-3 gap-4">
          ...
          {gameStatus && (<div className="col-span-3 sm:col-span-full">
            <button className="p-4 w-full bg-red-600 rounded-lg font-bold text-white mt-5 hover:bg-red-700" onClick={handleStopGame}>
              Stop Game
            </button>
          </div>)}
      ...
      {displayContent === START && (<div className="sm:col-span-4 flex flex-col flex-wrap justify-center content-center">
        {!showTimer && !showContent && (<div className="w-full md:w-2/4 lg:w-1/4 bg-gray-700 p-3 my-3 rounded-lg">
      ...
      {displayContent === RULES && (<div className="sm:col-span-4 gmd:col-span-4 text-center">
        <div className="col-span-full flex flex-wrap justify-center content-center">
          ...
          {alphaRules.map((alpha) => (<div className="grid col-span-1 bg-gray-600 m-2 flex flex-wrap justify-center content-center rounded-lg" key={randomChar() + alpha.name}>
      ...
      {displayContent === ACTIONLIST &&
        (<div className="sm:col-span-4 text-white p-6">
