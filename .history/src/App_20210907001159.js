...
const App = (props) => {
  ...
  return (
    <div className="bg-gray-900 min-h-screen grid grid-cols-5 p-3">
      ...
      {displayContent === START && (<div className="sm:col-span-1 max-w-xl md:col-span-4 flex flex-col flex-wrap justify-center content-center">
        {!showTimer && !showContent && (<div className="sm:max-w-xl  bg-gray-700 p-3 my-3 rounded-lg">
