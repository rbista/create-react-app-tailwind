...
const App = (props) => {
  ...
  // const setFontSize=()=
  return (
    <div className="bg-gray-900 min-h-screen p-3 grid grid-rows-3 sm:grid-cols-2 md:grid-cols-5 gap-2">

      <div className="row-end-4 row-span-1 sm:col-span-1 rounded-lg">
      ...
      {displayContent === START && (<div className="row-start-1 row-span-3 sm:col-span-4  flex flex-col flex-wrap justify-center content-center">
