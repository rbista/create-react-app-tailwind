...
const App = (props) => {
  ...
  return (
    <div className="bg-gray-900 p-6 grid grid-cols-5">
      ...
      <div className="sm:col-span-3 md:col-span-4 flex flex-wrap justify-center content-center">
      <h1 className={`text-${fontSize} text-white ${fontCapital ? 'uppercase': 'lowercase'}`}>{displaChar}</h1>
      </div>
      <div id="countdown" className={`sm:col-span-3 md:col-span-4 flex flex-wrap justify-center content-center ${showContent?'hidden':'block'}`}>
