      ...
      <div className={`h-screen w-full fixed left-0 top-0 flex justify-center items-center bg-opacity-90 bg-gray-900 ${modalStatus ? 'block' : 'hidden'}`}>
        <dialog open={modalStatus} className="rounded-lg bg-white rounded shadow-lg w-10/12 md:w-1/2 p-0">
          ...
          <div class="p-3">
            {/* <form id="actionForm" action=""> */}
              <label class="block">
                ...
                <input value={newAction.name} onChange={(event) => handleActionForm(event.targetvalue, newAction.value)} class="block @error('email') w-full appearance-none placeholder-gray-500 border border-gray-400 rounded-md py-3 px-4 my-1 text-gray-700 leading-5 focus:outline-none focus:ring-2 focus:ring-blue-300" placeholder="Action Name" required />
              </label>
              <label class="block">
          ...
          <div class="flex justify-end items-center w-100 border-t p-3">
            ...
            <button class="bg-blue-600 hover:bg-blue-700 px-3 py-1 rounded text-white" type="submit" onClick={handleSaveNewAction} >Save</button>
            {/* </div> */}
            {/* </div> */}
