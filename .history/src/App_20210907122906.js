...
const App = (props) => {
  ...
  // const setFontSize=()=
  return (
    <div className="bg-gray-900 min-h-screen p-3 grid sm:grid-cols-2 md:grid-cols-5 gap-2">

      <div className="row-start-4 sm:col-span-1 rounded-lg flex items-end">
        ...
        {gameStatus && (<div className="col-span-1  sm:col-span-full">
            <button className=" p-4 w-full bg-purple-600 rounded-lg font-bold text-white md:mb-4 hover:bg-purple-700 flex justify-center items-center" onClick={() => setDisplayContent(ACTIONLIST)} disabled={gameStatus}>
              Actions
            </button>
          </div>)}
          {gameStatus && (<div className="col-span-1  sm:col-span-full">
            <button className="p-4 w-full bg-purple-600 rounded-lg font-bold text-white md:mb-4 hover:bg-purple-700" onClick={() => setDisplayContent(RULES)} disabled={gameStatus}>
              Rules
            </button>
          </div>)}
          {gameStatus && (<div className="col-span-1 sm:col-span-full">
      ...
      <div className="row-start-1 row-span-3 sm:col-span-4">
        ...
        {displayContent === RULES && (<div className="sm:col-span-4 text-center">
