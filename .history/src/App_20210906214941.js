    ...
    <div className="bg-gray-900 p-6 h-screen grid grid-cols-5">
      ...
      {showActions &&
        (<div className="sm:col-span-3 md:col-span-4 text-white p-6">
          ...
          <dialog open={modalStatus} className="rounded-lg"><div className="w-full h-full bg-gray-800"><div class="border-b flex justify-between items-center">
          ...
          </div>This is an open dialog window</div></dialog>
        </div>)}
    </div>
