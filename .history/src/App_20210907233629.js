...
import { Rules, Menu, Settings, Gestures, Game, GameBody } from './Components';
  ...
  return (
    <div>
      {!loading && (<div className="bg-gray-900 min-h-screen h-auto p-3  text-white grid sm:grid-cols-2 md:grid-cols-5 sm:grid-rows-1 gap-2">
        ...
        <GameBody defaultData={fromLocalStorage} gameStatus={gameStatus} displayContent={displayContent}/>
      </div>)}
