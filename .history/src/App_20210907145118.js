...
const App = (props) => {
  ...
  const genCharAction = () => {
    ...
    localStorage.getItem('mind-game', { name: 'rajeev', lastname: 'bista' });
  }
  ...
  // const setFontSize=()=
  return (
    <div className="container mx-auto bg-gray-900 min-h-screen h-auto p-3 grid sm:grid-cols-2 md:grid-cols-5 sm:grid-rows-1 gap-2">
      ...
      <div className="row-start-1 sm:row-start-1 row-span-3 sm:col-span-4">
        ...
        {displayContent === RULES && (<div className="sm:col-span-4 text-center h-full">
          ...
          <div className="grid grid-cols-4 sm:grid-cols-7 h-full gap-2">
