    ...
    <div className="bg-gray-900 p-6 h-screen grid grid-cols-5">
      ...
      {showActions &&
        (<div className="sm:col-span-3 md:col-span-4 text-white p-6">
          ...
          <div className={`h-screen w-full fixed left-0 top-0 flex justify-center items-center bg-opacity-50 bg-gray-800 ${modalStatus?'block':'hidden'}`}>
          <dialog open={modalStatus} className="rounded-lg"><div class="border-b flex justify-between items-center">
          ...
          </div>This is an open dialog window</dialog>
            </div>
        </div>)}
    </div>
