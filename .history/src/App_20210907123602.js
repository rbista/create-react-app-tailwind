...
const App = (props) => {
  ...
  // const setFontSize=()=
  return (
    <div className="bg-gray-900 min-h-screen p-3 grid sm:grid-cols-2 md:grid-cols-5 sm:grid-rows-1 gap-2">

      <div className="row-start-4 sm:col-span-1 rounded-lg flex items-end sm:items-start">
