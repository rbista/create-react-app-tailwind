...
const App = (props) => {
  ...
  // const setFontSize=()=
  return (
    <div className="bg-gray-900 sm:min-h-screen p-3 grid sm:grid-cols-2 md:grid-cols-5 gap-2">
      ...
      {displayContent === START && (<div className="sm:col-span-4 min-h-screen flex flex-col flex-wrap justify-center content-center">
...
//     <div className="bg-gray-900 sm:min-h-screen p-3 grid sm:grid-cols-5 gap-2">
//       <div className="sm:col-span-2 bg-gray-800 text-white text-center">
// A
//       </div>
//       <div className="sm:col-span-3 bg-blue-300 text-white text-center">
// B
// console.assert(v
// <br/>
// v
