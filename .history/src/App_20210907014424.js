...
const App = (props) => {
  ...
  return (
    <div className="bg-gray-900 min-h-screen p-3 grid md:grid-cols-5 gap-2">
      ...
      {displayContent === START && (<div className="col-span-11 sm:col-start-2 sm:col-span-4  flex flex-col flex-wrap justify-center content-center">
        ...
        <div className={`col-start-1 ${showContent ? 'block' : 'hidden'}`}>
